...
augroup ft_textile
    ...
    au BufNewFile,BufRead *.textile setlocal filetype=textile
"reading vimwiki filetype like textile, hopefully no unforeseen drawbacks.
    au BufNewFile,BufRead *.wiki setlocal filetype=textile

    " TODO: Think of something else to put here...
augroup END
...
nnoremap <leader>es <C-w>v<C-w>j:e ~/.vim/bundle/vim-snippets/<cr>
...
" }}}
" UltiSnips {{{
  " let g:UltiSnipsSnippetDirectories=["~/.vim/bundle/vim-snippets/UltiSnips", "~/.vim/bundle/vim-snippets/snippets"]
" }}}
" VimClojure {{{
